...
impl Instruction {
    ...
    fn from_byte_not_prefixed(byte: u8) -> Option<Instruction> {
        match byte {
            ...
            0x08 => Some(Instruction::DEC(ArithmeticTargetType::Word(
                ArithmeticWordTarget::BC,
            ))),
            0x09 => Some(Instruction::ADD(AddTargetType::Word(
                ArithmeticWordTarget::BC,
            ))),
            0x0A => Some(Instruction::LD(LoadType::AFromIndirect(LdIndirectAddr::BC))),
            0x0B => Some(Instruction::DEC(ArithmeticTargetType::Word(
                ArithmeticWordTarget::BC,
            ))),
            0x0C => Some(Instruction::INC(ArithmeticTargetType::Byte(
                ArithmeticByteTarget::C,
            ))),
            0x0D => Some(Instruction::DEC(ArithmeticTargetType::Byte(
                ArithmeticByteTarget::C,
            ))),
            ...
            0x13 => Some(Instruction::INC(ArithmeticTargetType::Word(
                ArithmeticWordTarget::DE,
            ))),
            0x14 => Some(Instruction::INC(ArithmeticTargetType::Byte(
                ArithmeticByteTarget::D,
            ))),
            0x15 => Some(Instruction::DEC(ArithmeticTargetType::Byte(
                ArithmeticByteTarget::D,
            ))),
            ...
            0x19 => Some(Instruction::ADD(AddTargetType::Word(
                ArithmeticWordTarget::DE,
            ))),
            0x1A => Some(Instruction::LD(LoadType::AFromIndirect(LdIndirectAddr::DE))),
            0x1B => Some(Instruction::DEC(ArithmeticTargetType::Word(
                ArithmeticWordTarget::DE,
            ))),
            0x1C => Some(Instruction::INC(ArithmeticTargetType::Byte(
                ArithmeticByteTarget::C,
            ))),
            0x1D => Some(Instruction::DEC(ArithmeticTargetType::Byte(
            ...
            0x23 => Some(Instruction::INC(ArithmeticTargetType::Word(
                ArithmeticWordTarget::HL,
            ))),
            0x24 => Some(Instruction::INC(ArithmeticTargetType::Byte(
                ArithmeticByteTarget::H,
            ))),
            0x25 => Some(Instruction::DEC(ArithmeticTargetType::Byte(
                ArithmeticByteTarget::H,
            ))),
            ...
            0x29 => Some(Instruction::ADD(AddTargetType::Word(
                ArithmeticWordTarget::HL,
            ))),
            0x2A => Some(Instruction::LD(LoadType::HLIncIntoA)),
            0x2B => Some(Instruction::DEC(ArithmeticTargetType::Word(
                ArithmeticWordTarget::HL,
            ))),
            0x2C => Some(Instruction::INC(ArithmeticTargetType::Byte(
                ArithmeticByteTarget::L,
            ))),
            0x2D => Some(Instruction::DEC(ArithmeticTargetType::Byte(
                ArithmeticByteTarget::L,
            ))),
            ...
            0x33 => Some(Instruction::INC(ArithmeticTargetType::Word(
                ArithmeticWordTarget::SP,
            ))),
            0x34 => Some(Instruction::INC(ArithmeticTargetType::Byte(
                ArithmeticByteTarget::HLI,
            ))),
            0x35 => Some(Instruction::DEC(ArithmeticTargetType::Byte(
                ArithmeticByteTarget::HLI,
            ))),
            ...
            0x39 => Some(Instruction::ADD(AddTargetType::Word(
                ArithmeticWordTarget::SP,
            ))),
            0x3A => Some(Instruction::LD(LoadType::HLDecIntoA)),
            0x3B => Some(Instruction::DEC(ArithmeticTargetType::Word(
                ArithmeticWordTarget::SP,
            ))),
            0x3C => Some(Instruction::INC(ArithmeticTargetType::Byte(
                ArithmeticByteTarget::A,
            ))),
            0x3D => Some(Instruction::DEC(ArithmeticTargetType::Byte(
                ArithmeticByteTarget::A,
            ))),
            ...
            0xF2 => Some(Instruction::LD(LoadType::AFromByteAddress(
                LdByteAddress::C,
            ))),
...
mod tests {
    ...
    fn test_all_decodes(opcode: u8, prefixed: bool) {
        ...
        if prefixed {
            assert!(
                !Instruction::from_byte(opcode, true).is_none(),
                "failed prefixed opcode: 0x{:x}",
                opcode
            );
        } else {
            if !ndef.contains(&opcode) {
                assert!(
                    ...
                    "failed non_prefixed opcode: 0x{:x}",
                    opcode
                );
            }
        }
